    ...
    public class PermisstionDao
    {
        ...
        public PermisstionObject GetByPerID(Guid ID)
        {
            ...
            foreach (var item in list)
            {
                ...
                obj.PerID = item.PerID; obj.F_ADD = item.F_ADD == true; obj.F_EDIT = item.F_EDIT == true; obj.F_DELETE = item.F_DELETE == true; obj.F_SEARCH = item.F_SEARCH == true; obj.FeaId = item.FeaId; obj.UserId = item.UserId;
                return obj;
            }
            return null;
        }
